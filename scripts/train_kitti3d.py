...
from pipeline.datasets import get_kitti3d_train_val_test_datasets
...
flags.DEFINE_integer('num_workers', 8, 'Set the number of cpu workers')
...
flags.DEFINE_string('dataset_path',
                    '/esat/topaz/gkouros/datasets/KITTI3D',
...
flags.DEFINE_enum('occlusion_level', 'all',
...
def main():
    ...
    train_dataset, val_dataset, test_dataset = \
        get_kitti3d_train_val_test_datasets(
    ...
    logging.info(
        f'Feature Embedding: '
        f'Image -- trunk --> {backbone().fc.in_features} '
